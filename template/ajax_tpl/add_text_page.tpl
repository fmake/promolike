[[for textlike in textlikes]]
	<tr> 
		...
		<td class="button">
			<center>
				<img id="active-edit-text-{textlike.id_text_like}" src="/images/note_edit.png" title="редактировать текст" onclick="xajax_editTextPage({textlike.id_text_like},{id_user},{id_project});return false;"/>
				...
				<img src="[[if textlike.publick_active]]/images/control_play_blue.png[[else]]/images/control_pause_blue.png[[endif]]" id="text_pub_active{textlike.id_text_like}" title="опубликовать " onclick="xajax_publicText({id_page},{textlike.id_text_like},{id_user},{id_project});return false;"/>
